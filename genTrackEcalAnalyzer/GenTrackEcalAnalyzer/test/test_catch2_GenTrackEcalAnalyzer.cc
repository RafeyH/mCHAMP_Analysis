...
static constexpr auto s_tag = "[GenTrackEcalAnalyzer]";

TEST_CASE("Standard checks of GenTrackEcalAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("GenTrackEcalAnalyzer"
